...
const Contact = () => {
  ...
  return (
    <div id="contact" className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full px-8 py-4 cursor-pointer bg-gradient-to-r from-blue-400 to-blue-900 text-white font-bold rounded-lg hover:from-pink-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl relative overflow-hidden"
              >
