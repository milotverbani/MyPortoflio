      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300">Email: <a href="mailto:milot.verbani233@gmail.com" className="hover:text-white transition-colors">milot.verbani233@gmail.com</a></p>
            <p className="text-gray-300">Phone: <a href="tel:+383-049-329-546" className="hover:text-white transition-colors">+383-49-329-546</a></p>
          </div>
        </div>
